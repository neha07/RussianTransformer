...
class NewNoteFragment : Fragment(R.layout.fragment_new_note) {
    ...
    private fun saveNote(view: View){
        ...
        val noteX = binding.etNumberX.text.toString().toInt()
        val noteY = binding.etNumberY.text.toString().toInt()
        ...
        binding.btnTransform.setOnClickListener {
            binding.tvNoteContent.setText(result)
        }


        if(noteX != null){
            val note = Note(0,noteX,noteY,result)
